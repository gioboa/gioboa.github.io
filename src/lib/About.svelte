<div id="about-me" class="bg-white dark:bg-gray-800 md:p-20">
	...
	>
		...
		<div>
			<div
				class="text-2xl md:text-4xl font-bold py-[30px] text-center text-gray-700 dark:text-gray-400"
			>
				About Me
			</div>
			<div class="px-20 text-xl text-gray-700 dark:text-gray-400">
				I'm a full stack developer and the front-end ecosystem is my passion. I
				started to develop application in 2006 and in 2012 I fall in love with
				JavaScript<br /><br />
				I'm active in open source ecosystem, I love learn and study new things
				<br />
				...
				In all these years I learned a lot from communities and open source ❤️
				<br />
