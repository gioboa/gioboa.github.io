...
export default component$(() => {
	const links = [
		{
			href: 'https://it.linkedin.com/in/giorgio-boa',
		...
		{
			href: 'https://twitter.com/giorgio_boa',
			path: 'm1.93 1.93 4.732 6.744L1.93 14.07h.996l4.196-4.768 3.345 4.768h3.603L9.1 7.103l4.546-5.173H12.61L8.638 6.457 5.458 1.93Zm1.477.776h1.627l7.52 10.588H10.91Z',
			label: 'twitter',
		},
		{
